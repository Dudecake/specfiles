...
Provides:       bundled(golang(cloud.google.com/go/compute))
Provides:       bundled(golang(cloud.google.com/go/compute/metadata))
Provides:       bundled(golang(github.com/antlr/antlr4/runtime/Go/antlr))
Provides:       bundled(golang(github.com/armon/circbuf))
Provides:       bundled(golang(github.com/armon/go-socks5))
...
Provides:       bundled(golang(github.com/cenkalti/backoff/v4))
...
Provides:       bundled(golang(github.com/golang-jwt/jwt/v4))
...
Provides:       bundled(golang(github.com/go-logr/stdr))
Provides:       bundled(golang(github.com/go-logr/zapr))
Provides:       bundled(golang(github.com/googleapis/enterprise-certificate-proxy))
...
Provides:       bundled(golang(github.com/google/cadvisor/third_party/containerd))
...
Provides:       bundled(golang(github.com/google/gnostic))
...
Provides:       bundled(golang(github.com/grpc-ecosystem/grpc-gateway/v2))
...
Provides:       bundled(golang(github.com/stoewer/go-strcase))
...
Provides:       bundled(golang(google.golang.org/genproto/googleapis/rpc))
...
Provides:       bundled(golang(go.opentelemetry.io/contrib/instrumentation/github.com/emicklei/go-restful/otelrestful))
...
Provides:       bundled(golang(go.opentelemetry.io/otel/exporters/otlp/internal/retry))
Provides:       bundled(golang(go.opentelemetry.io/otel/exporters/otlp/otlptrace))
Provides:       bundled(golang(go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc))
...
Provides:       bundled(golang(go.uber.org/goleak))
...
Provides:       bundled(golang(k8s.io/kube-openapi/pkg/internal/third_party/go-json-experiment/json))
...
Provides:       bundled(golang(sigs.k8s.io/kustomize/kustomize/v5))
