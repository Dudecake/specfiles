...
for dir in ./*/; do
  ...
  if [[ -f ./srpm.sh ]]; then
    ...
    . ./srpm.sh
    mkdir ../${_package}
    sed 's/dbus-devel/dbus-1-devel/g; s/libappstream-glib/libappstream-glib8/g; s/libseat-devel/seatd-devel/g; s/mesa-libgbm-devel/libgbm-devel/g; /rust-rav1e+nasm-rs-devel/d; s/rustc/rust/g; s/%{_metainfodir}/%{_datadir}\/metainfo/g' ./${_package}.spec > ../${_package}/${_package}.spec
